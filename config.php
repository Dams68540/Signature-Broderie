 ...
 * "/application" or other folder inside your application or call any other .php file than index.twig inside "/public".
 *
 * URL_PROTOCOL:
...
define('DB_HOST', 'signaturlcbdr.mysql.db');
define('DB_NAME', 'signaturlcbdr');
define('DB_USER', 'signaturlcbdr');
define('DB_PASS', 'Lamouille@123');
